...
def train(model, loader, device, optimizer, epoch, label_names):   #criterion with BCELoss
    model.train()
    total_loss = 0
...
def main():
    ...
    df = pd.read_csv('C:/Users/suman/OneDrive/Bureau/Internship_Study/GNN_On_OdorPrediction/data/Data_Sampling/Saturated_SoS_Top138.csv',encoding='ISO-8859-1')

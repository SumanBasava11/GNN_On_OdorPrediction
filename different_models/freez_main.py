...
# def bootstrap_ci(y_true, y_prob, n_bootstrap=1000, ci=95, random_state=None):
...
#         try:
#             auc = roc_auc_score(y_true_boot, y_prob_boot, average='macro')
#             aucs.append(auc)
#         except ValueError:
#             # if only one class present in this bootstrap sample, skip
#             continue

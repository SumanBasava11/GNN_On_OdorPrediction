...
class OdorClassifier(nn.Module):
    def __init__(self, num_tasks, mlp_dims=[100, 80], dropout_p=0.2):
        ...
        # self.conv3 = GINConv(make_gin_mlp(27, 36, dropout_p))
        # # self.pool1 = SAGPooling(36, ratio=0.8, GNN = GraphConv)
        # self.bn3 = nn.BatchNorm1d(36)
        # self.drop3 = nn.Dropout(p=dropout_p)

        # self.conv4 = GINConv(make_gin_mlp(36, 92, dropout_p))
        # # self.pool1 = SAGPooling(92, ratio=0.8, GNN = GraphConv)
